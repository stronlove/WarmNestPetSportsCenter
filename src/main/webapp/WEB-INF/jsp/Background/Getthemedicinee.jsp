...
<html>
  <head>
    ...
    <title>My JSP 'Getthemedicinee.jsp' starting page</title>
...
<script type="text/javascript" src="js/jquery-1.9.1.js"></script>
  <body>
			...
			<c:if test="${pm.rows.size()>0 }">
				<c:forEach items="${pm.rows}" var="l">
					<tr>
						...
						<td><a href="Commodityselect?openlistno=${l.openlistno }" class="btn btn-info">查看详情</a></td>
					</tr>
				</c:forEach>
			</c:if>
           <tr>
               <td colspan="6">
	               <pg:pager url="Getthemedicinee"  items="${pm.total}"  export="currentPageNumber=pageNumber"   maxPageItems="${pm.pagesize}" >
	...
	<button style="position: absolute;left: 520px;top: 10px;width: 150px;z-index: 10;" class="btn btn-info" onclick="asd()">返回上一页</button>
