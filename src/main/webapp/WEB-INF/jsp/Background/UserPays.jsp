...
<script type="text/javascript" src="js/jquery-1.9.1.js"></script>
  ...
  <button onclick="asd()" class="btn btn-info" style="width:100px;height: 30px;position: absolute;left: 500px;top: 50px;z-index:10;" >正在付钱</button>
  <button onclick="qwe()" class="btn btn-info" style="width:100px;height: 30px;position: absolute;left: 800px;top: 50px;z-index:10;" >已付钱</button>
	<!-- 表格 -->
	<table class="table table-striped"
		...
		<tbody>
           ...
           <tr>
               <td colspan="6">
	               <pg:pager url="UserPays"  items="${pm.total}"  export="currentPageNumber=pageNumber"   maxPageItems="${pm.pagesize}" >
...
<div id="mask"></div>
	...
	<script type="text/javascript">
		...
		function fuqian(openlistno,usernoa){
  		...
  		function asd(){
  			window.location.href="UserPaya";
  		}
  		function qwe(){
  			window.location.href="UserPayw";
  		}
	</script>
  </body>
</html>